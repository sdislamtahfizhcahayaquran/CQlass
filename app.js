...
async function refreshBellNotif(){
  ...
  try{
    ...
    // Pakai payload yang sama untuk badge keterlambatan sidebar.
    pendingKeterlambatanCount = Number(res.pendingTelat) || 0;
    renderSidebar();
...
function enterApp(){
  ...
  // Startup dibuat bertahap agar dashboard tampil dulu, baru request non-kritis.
