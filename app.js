...
function injectRaporPreviewStyles(){
  ...
  const s=document.createElement('style');s.id='rapor-v1-style';s.textContent=`
    ...
    .rpv-actions{display:flex;gap:9px;flex-wrap:wrap;align-items:center;margin-top:12px}.rpv-paper-wrap{overflow:auto;padding:10px 0 22px}.rpv-paper{position:relative;width:210mm;height:297mm;min-height:297mm;max-height:297mm;margin:0 auto 18px;background:#fff;color:#111;padding:4.2mm 3.7mm 5.5mm;box-shadow:0 8px 30px rgba(0,0,0,.12);font-family:Arial,Helvetica,sans-serif;font-size:10px;line-height:1.14;box-sizing:border-box;overflow:hidden}.rpv-paper *{box-sizing:border-box}
    .rpv-template-head{width:100%;border-collapse:collapse;border:2px solid #111;margin:0}.rpv-template-head td{border:2px solid #111;height:26px;padding:2px 4px;vertical-align:middle}.rpv-template-head .head-left{width:50.9%;text-align:center;font-weight:900;font-size:12.2px}.rpv-template-head .head-right{font-size:9.8px}.rpv-template-shadow{height:6px;background:#e7e7e7;margin:0 1px 11px}
    .rpv-section-plain{font-weight:900;font-size:10.7px;margin:7px 3px 3px}.rpv-tahfizh{width:100%;border-collapse:collapse;margin:0 3px 8px;font-size:9.9px}.rpv-tahfizh td{padding:1px 3px;border:0;vertical-align:top}.rpv-tahfizh td:first-child{width:38%}.rpv-tahfizh td:nth-child(2){width:2%}.rpv-tahfizh .sub{padding-left:20px}
    .rpv-table{width:100%;border-collapse:collapse;table-layout:fixed}.rpv-table th,.rpv-table td{border:1px solid #111;padding:2px 3px;vertical-align:middle}.rpv-table th{background:#dce7f1;font-weight:900;text-align:center}.rpv-center{text-align:center}.rpv-left{text-align:left}.rpv-academic{font-size:8.6px;line-height:1.08}.rpv-academic th,.rpv-academic td{padding:2px 2px}.rpv-academic .no{width:4%}.rpv-academic .subject{width:35%}.rpv-academic .kktp{width:12.5%}.rpv-academic .lo{width:6.7%}.rpv-academic .remarks{width:14.8%}.rpv-academic tbody td{height:16px}.rpv-start4{background:#dedede!important}.rpv-group-row td{background:#d9d9d9;font-weight:900}
    .rpv-att-grid{display:grid;grid-template-columns:65% 29%;gap:6%;align-items:start;margin:8px 0 0}.rpv-att-grid .rpv-section-plain{margin-left:3px}.rpv-attendance{font-size:8.8px}.rpv-attendance th,.rpv-attendance td{height:20px}.rpv-score-table{font-size:8.8px;margin-top:21px}.rpv-score-table th,.rpv-score-table td{height:20px}
    .rpv-p2-section{font-weight:900;font-size:11px;margin:0 2px 4px}.rpv-p2-sub{font-weight:400;font-size:10.2px;margin:8px 2px 3px}.rpv-p2-sub b{font-weight:900}.rpv-exkul{font-size:9.4px}.rpv-exkul th,.rpv-exkul td{height:25px}.rpv-exkul td{padding:4px 6px;line-height:1.28}.rpv-exkul td:last-child{font-size:8.6px}.rpv-discipline{font-size:9.2px}.rpv-discipline th{height:48px}.rpv-discipline td{height:23px}.rpv-merit{font-size:9.2px}.rpv-merit th{height:28px}.rpv-merit td{height:23px}.rpv-total-line{border:1px solid #111;border-top:0;padding:4px 3px;font-size:9.4px}
