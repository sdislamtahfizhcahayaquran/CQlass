...
function injectRaporPreviewStyles(){
  ...
  const s=document.createElement('style');s.id='rapor-v1-style';s.textContent=`
    ...
    .rpv-actions{display:flex;gap:9px;flex-wrap:wrap;align-items:center;margin-top:12px}.rpv-paper-wrap{overflow:auto;padding:10px 0 22px}.rpv-paper{position:relative;width:210mm;height:297mm;min-height:297mm;max-height:297mm;margin:0 auto 18px;background:#fff;color:#111;padding:15mm 5mm 8mm 3mm;box-shadow:0 8px 30px rgba(0,0,0,.12);font-family:Tahoma,Verdana,'Segoe UI',sans-serif;font-size:10px;line-height:1.3;box-sizing:border-box;overflow:hidden}.rpv-paper *{box-sizing:border-box}
    .rpv-template-head{width:100%;border-collapse:collapse;border:1.5px solid #111;margin:0}.rpv-template-head td{border:1.5px solid #111;height:7.46mm;padding:2px 4px;vertical-align:middle}.rpv-template-head .head-left{width:50.9%;text-align:center;font-weight:900;font-size:11px}.rpv-template-head .head-right{font-size:10px;display:flex;align-items:center}.hr-label{flex:0 0 33mm}.hr-colon{flex:0 0 3mm}.hr-value{flex:1}.rpv-template-shadow{height:2.1mm;background:#e7e7e7;margin:0 0 5.8mm}
    ...
    .rpv-p2-section{font-weight:900;font-size:11px;margin:0 0 4px}.rpv-p2-sub{font-weight:400;font-size:10px;margin:8px 0 3px}.rpv-p2-sub b{font-weight:900}.rpv-exkul{font-size:10px}.rpv-exkul th,.rpv-exkul td{height:6.9mm}.rpv-exkul td{padding:2px 5px;line-height:1.22}.rpv-exkul td:last-child{font-size:10px}.rpv-discipline{font-size:10px}.rpv-discipline th{height:8mm}.rpv-discipline td{height:6.9mm}.rpv-merit{font-size:10px}.rpv-merit th{height:6.9mm}.rpv-merit td{height:6.9mm}.rpv-total-line{border:1.5px solid #111;border-top:0;padding:4px 3px;font-size:10px}
    .rpv-date-center{position:absolute;left:50%;transform:translateX(-50%);top:163mm;text-align:center;font-size:10px;line-height:1.5;min-width:45mm}.rpv-signatures{position:absolute;left:3mm;right:5mm;top:181mm;height:37mm;font-size:10px;display:flex;justify-content:space-between}.rpv-signatures>div{width:30%;display:flex;flex-direction:column;align-items:center;text-align:center}.rpv-signatures .name,.rpv-signatures .blank-line{margin-top:31mm}.rpv-signatures .name{text-decoration:underline;font-weight:400;white-space:nowrap}.rpv-signatures .blank-line{border-bottom:2px dashed #111;width:60%;height:1px}
    .rpv-team-area{position:absolute;left:3mm;right:5mm;top:223mm;display:grid;grid-template-columns:max-content max-content;column-gap:6mm;font-size:10px}.rpv-team-title{font-weight:400;margin-bottom:4px}.rpv-team-simple{border-collapse:collapse}.rpv-team-simple td{border:0;padding:2px 1px;vertical-align:top}.rpv-team-simple td:first-child{width:14px}.rpv-team-simple td:last-child{white-space:nowrap}.rpv-position-list div{padding:2px 0;white-space:nowrap}
    .rpv-footer{position:absolute;left:3mm;right:5mm;bottom:3.8mm;display:flex;justify-content:space-between;font-size:10px;font-style:italic}.pv2-toolbar{display:flex;justify-content:space-between;align-items:center;gap:10px}.rpv-print-btn{display:inline-flex;align-items:center;gap:7px}
