...
function injectRaporPreviewStyles(){
  ...
  const s=document.createElement('style');s.id='rapor-v1-style';s.textContent=`
    ...
    .rpv-date-center{position:absolute;left:50%;transform:translateX(-50%);top:163mm;text-align:center;font-size:10px;line-height:1.5;min-width:45mm}.rpv-signatures{position:absolute;left:7mm;right:7mm;top:181mm;height:37mm;font-size:10px;display:flex;justify-content:space-between}.rpv-signatures>div{width:30%;display:flex;flex-direction:column;align-items:center;text-align:center}.rpv-signatures .name,.rpv-signatures .blank-line{margin-top:31mm}.rpv-signatures .name{text-decoration:underline;font-weight:400;white-space:nowrap}.rpv-signatures .blank-line{border-bottom:1px dashed #999;width:60%;height:1px}
    .rpv-team-area{position:absolute;left:7mm;right:7mm;top:223mm;display:grid;grid-template-columns:max-content max-content;column-gap:6mm;font-size:10px}.rpv-team-title{font-weight:400;margin-bottom:4px}.rpv-team-simple{border-collapse:collapse}.rpv-team-simple td{border:0;padding:2px 1px;vertical-align:top}.rpv-team-simple td:first-child{width:14px}.rpv-team-simple td:last-child{white-space:nowrap}.rpv-position-list div{padding:2px 0;white-space:nowrap}
