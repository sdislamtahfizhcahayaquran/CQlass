...
(function(){
  ...
  function loadFinal(){
    ...
    if(!document.querySelector('script[data-cq-tahfizh-kabid-dash]')&&!window.__CQ_TAHFIZH_KABID_DASH__){const k=document.createElement('script');k.src='tahfizh-kabid-dashboard.js?v=20260924-kabidfeat1';k.dataset.cqTahfizhKabidDash='1';k.async=false;(document.body||document.head).appendChild(k)}
  }
