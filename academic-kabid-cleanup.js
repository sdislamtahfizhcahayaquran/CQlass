...
(function(){
  'use strict';
  function loadFinal(){
    // Dashboard Akademik memakai standalone V7 sebagai satu-satunya renderer.\n    // Jangan muat academic-kabid-dashboard-final.js karena fungsinya duplikat dan dapat saling overwrite.
    ...
    if(!document.querySelector('script[data-cq-tahfizh-kabid-dash]')&&!window.__CQ_TAHFIZH_KABID_DASH__){const k=document.createElement('script');k.src='tahfizh-kabid-dashboard.js?v=20260924-kabidfeat3';k.dataset.cqTahfizhKabidDash='1';k.async=false;(document.body||document.head).appendChild(k)}
  }
