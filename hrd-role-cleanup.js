...
const state={active:'dashboard',month:jktDate().slice(0,7),admin:null,liveQuery:'',liveSort:'issues',monthlyQuery:'',monthlyRole:'all',monthlyStatus:'all',monthlySort:'az'};
