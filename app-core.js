...
function injectRaporPreviewStyles(){
  ...
  const s=document.createElement('style');s.id='rapor-v1-style';s.textContent=`
    ...
    .rpv-template-head{width:100%;border-collapse:collapse;border:1.25px solid #111;margin:0}.rpv-template-head td{border:1.25px solid #111;height:6.5mm;padding:1px 4px;vertical-align:middle}.rpv-template-head .head-left{width:50.9%;text-align:center;font-weight:900;font-size:14.5px}.rpv-template-head .head-right{font-size:13px;display:flex;align-items:center}.hr-label{flex:0 0 33mm}.hr-colon{flex:0 0 3mm}.hr-value{flex:1}.rpv-template-shadow{height:2.1mm;background:#e7e7e7;margin:0 0 4mm}
    ...
    .rpv-date-center{margin:6mm auto 0;text-align:center;font-size:11px;line-height:1.5;min-width:45mm;width:max-content}.rpv-signatures{margin:14mm 0 0;height:37mm;font-size:11px;display:flex;justify-content:space-between}.rpv-signatures>div{width:30%;display:flex;flex-direction:column;align-items:center;text-align:center;position:relative}.rpv-signatures .name,.rpv-signatures .blank-line{margin-top:31mm;line-height:1.1}.rpv-signatures .blank-line{display:block;width:60%;height:1px;border-bottom:1px solid #111}.rpv-signatures .name{display:inline-block;width:auto;font-size:11px;font-weight:900;white-space:nowrap;text-decoration:none;border-bottom:1px solid #111;padding-bottom:1px}.rpv-signature-img{position:absolute;top:5.5mm;left:50%;transform:translateX(-50%);max-width:46mm;max-height:24mm;object-fit:contain;z-index:2}
    .rpv-team-area{margin:10mm 0 0;display:grid;grid-template-columns:max-content max-content;column-gap:6mm;font-size:11px}.rpv-team-title{font-weight:400;margin-bottom:4px}.rpv-team-simple{border-collapse:collapse}.rpv-team-simple td{border:0;padding:2px 1px;vertical-align:top}.rpv-team-simple td:first-child{width:14px}.rpv-team-simple td:last-child{white-space:nowrap}.rpv-position-list div{padding:2px 0;white-space:nowrap}
