...
function rpEkskulRemarkWithContext(kind,grade,eks){const base=rpEkskulRemark(kind,grade);if(kind==='competition'&&String(eks?.competition_note||'').trim())return String(eks.competition_note).trim();return base}
